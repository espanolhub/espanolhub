...
export const drivingLessons: DrivingLesson[] = [
  // 15 enriched driving lessons
  {
    ...
    category: 'general',
    isFree: true,
    resumenClave: { es: 'Conceptos básicos: vehículos, conductores y vías públicas según la normativa española.', ar: 'المفاهيم الأساسية: المركبات والسائقون والطرقات العامة وفقاً للقانون الإسباني.' },
    erroresComunes: [
...
إشارات التحذير والأولوية والمنع والمعلومات.`,
  },
  {
...
معايير تحديد من له الأفضلية في مواقف مختلفة.`,
  },
  {
...
تقنيات وتوصيات للقيادة بأمان في الظروف الصعبة.`,
  },
  {
...
الآثار على القيادة والحدود القانونية واختبارات الكحول.`,
  },
  {
    id: 'driving-7-noche',
...
ممارسات جيدة للقيادة ليلاً وتجنّب المخاطر.`,
  },
  {
...
أنواع الوقوف والإشارات والعقوبات عند المخالفة.`,
  },
  {
...
توصيات وأنواع مقاعد الأطفال حسب السن والوزن.`,
  },
  {
...
قائمة فحص أساسية للحفاظ على المركبة بحالة جيدة.`,
  },
  {
...
مفاهيم أساسية حول صيانة المحرك والوقاية من الأعطال.`,
  },
  {
...
كيفية التصرف بناءً على ظروف الطقس السيئة.`,
  },
  {
...
الإجراءات عند الحوادث والتواصل مع خدمات الطوارئ.`,
  },
  {
...
ممارسات جيدة للتنقل داخل المدينة.`,
  },
  {
...
قائمة مراجعة وتمارين قبل الامتحان.`,
  },
  {
...
المناورات هي تغييرات في موضع المركبة تتطلب إشارات وحذر واحترام قواعد المرور.
...
نظام المرور الإسباني يخضع لقواعد صارمة لضمان السلامة.
...
هذا الفصل مراجعة شاملة لجميع المفاهيم المهمة قبل الامتحان.
