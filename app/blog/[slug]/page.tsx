...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: 'Post no encontrado | Espanol Hub',
    };
  }

  return {
    title: `${post.title} | Blog Espanol Hub`,
    description: post.excerpt,
    keywords: ['aprender español', 'blog español', post.title],
    alternates: {
      canonical: `https://www.espanolhub.com/blog/${post.slug}`,
    },
    openGraph: {
      title: post.title,
      description: post.excerpt,
      type: 'article',
      url: `https://www.espanolhub.com/blog/${post.slug}`,
