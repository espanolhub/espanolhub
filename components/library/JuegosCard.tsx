...
export default function JuegosCard({ entry, onOpen }: { entry: any; onOpen?: (id: string) => void }) {
  return (
    <article className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
      ...
      <div className="mt-3 text-sm text-gray-700 line-clamp-3">{entry.excerpt || ''}</div>
