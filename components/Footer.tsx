      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-11 h-11 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg border border-slate-700">
              <span className="font-extrabold text-white text-lg">EH</span>
            </div>
            <div>
              <div className="flex items-baseline gap-1">
                <span className="text-lg font-extrabold text-slate-50">Español</span>
                <span className="text-lg font-extrabold text-slate-50">Hub</span>
              </div>
              <div className="text-[10px] text-slate-400 font-medium italic">Tu centro inteligente para aprender español</div>
            </div>
          </div>

          <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 rounded-full mb-4 border border-slate-700">
            <span className="text-sm font-semibold text-slate-100">Plataforma Educativa Abierta</span>
          </div>
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-sm text-slate-400 mb-4">
          ...
          <span className="text-slate-600" aria-hidden>·</span>
          <Link href="/faq" className="hover:text-blue-400 hover:underline transition-colors">FAQ</Link>
        </nav>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-sm mb-4">
          ...
          <div className="flex items-center gap-2 bg-slate-900 px-3 py-1 rounded-full border border-slate-700">
            ...
            <span className="text-sm font-semibold text-slate-200">Garantía de Satisfacción</span>
          </div>
        </div>

        {/* Copyright */}
        <p className="text-center text-sm text-slate-500">© 2026 Todos los derechos reservados. Espanol Hub.</p>
      </div>
    </footer>
  );
}
