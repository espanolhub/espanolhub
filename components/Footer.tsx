  ...
  return (
    <footer className="bg-white text-slate-900 mt-auto">
      <div className="container mx-auto px-4 py-10 flex flex-col">
        {/* Main Content: 3 Columns (desktop) / 1 column (mobile) */}
        <div className="order-2 md:order-1 grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          {/* Column 2: Legal & Social (desktop only) */}
        ...
        {/* Bottom: TikTok CTA (centered) + Legal horizontal + extras + copyright */}
        <div className="order-3 border-t border-gray-200 pt-6 pb-4 text-center space-y-5">
          {/* TikTok @esconabdou — prominent, centered */}
          ...
          {/* Legal links — horizontal, compact */}
