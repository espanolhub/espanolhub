          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex flex-1 max-w-2xl mx-8">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-400 hover:bg-slate-800 hover:border-slate-300 transition-all duration-200 text-left focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-slate-950 shadow-sm"
                aria-label="Buscar"
              >
